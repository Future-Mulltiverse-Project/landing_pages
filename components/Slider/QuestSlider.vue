  ...
  <div class="row"  style="background-color: #0A0D1D;">
      ...
      >
        <swiper-slide v-for="(item, index) in items" :key="index">
          <div class='mb-12' style=" background-image: url(/_nuxt/assets/images/slider/slider_background.png); background-repeat: no-repeat; background-size: cover; ">
              <div class="row">
                  <AppWrapper class="pb-12">
                      <div class='col-md-12 mt-10' style="padding-top:25px !important">
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-3 ">
                                  <div class="col-span-2">
                                      ...
                                      <div class="mt-8 mb-4 grid grid-cols-1 gap-3 md:grid-cols-2">
                                        <div class="flex md:justify-normal justify-center mb-4 md:mb-0">
                                          <button to="/" class="btn btn-outline-primary" :class="$style.btn" style=" font-weight: 500;  color: white; font-weight: 500;">
                                            LEARN MORE
                                          </button>
                                        </div>
                              ...
                              <div class="flex justify-center">
                                  <div class="card" style="width: 22rem; background-color: #15172E;">
                                      ...
                                      <div class="card-body"  style="padding: 30px; padding-top: 25px !important;" >
                                          ...
                                          <p class="text-lg pt-5 pb-5" style="color: #9C9C9C; text-align: center " >The Future Trends Multiverse & EXPO is created to be a catalyst for Humanitys’ destined Future</p>
                                          <div class='flex justify-center'>
      ...
      <AppWrapper> 
        <div class="row mb-12 pl-12 pr-12 md:pl-12 md:pr-12" style=" padding-top:12px !important">
          <div class="flex justify-center">
            <Carousel class="relative w-full max-w-screen-xl">
              <CarouselContent>
                  ...
                  <div class="p-1">
                    <Card class="grid grid-cols-1 gap-2">
                      <CardContent class="flex  items-center justify-center">
                        <img :src="item" class="img_resize lg:h-40 lg:w-fit h-28 w-32" style="  " />
                      </CardContent>
                    </Card>
                  </div>
                </CarouselItem>
