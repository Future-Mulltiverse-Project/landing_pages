<template>
  <section >
    <AppWrapper>
      <div class="grid grid-cols-1 gap-3 mt-8 md:grid-cols-2 mb-12">
        <div class="md:order-first">
          ...
          <div class=" grid grid-cols-1 gap-4 md:grid-cols-3 mb-4 md:mb-0"> 
            <div class="flex justify-center">
              <button class="btn btn-outline-primary pt-4 md:pt-2 md:pb-2 pb-4 font-semibold mr-2 mb-2">website</button>
            </div>
            <div class="flex justify-center">
              <button class="btn btn-outline-primary pt-4 md:pt-2 md:pb-2 pb-4 font-semibold mr-2 mb-2">Matrix</button>
            </div>
            <div class="flex justify-center">
              <button class="btn btn-outline-primary pt-4 pb-4 md:pt-2 md:pb-2 font-semibold mr-2 mb-2">Experience in fxpo</button>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
        ...
        <div>
          <MainSectionTextContent >
            <p class="text-lg" >The Future Multiverse is a multi-dimensional eco-system created to be a catalyst for humanity's destined future. <br/>
