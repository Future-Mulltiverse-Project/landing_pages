...
import GuidebookHeader from '~/components/Guidebook/GuidebookHeader.vue';
import GuidebookSidebar from '~/components/Guidebook/GuidebookSidebar.vue';
...
.content {
  ...
  position: relative;
  flex: 1 1 0;
  background-image: url(assets/images/graceai/guidebookBackground.png);
