<template>
  <section :class="$style.section">
    <div class="row">
      <h1 style="text-align: left; margin-bottom: 20px;"><span style="color: #CFB16D;">Examples </span>of <span style="color: #CFB16D;">Use-Cases</span> & <span style="color: #CFB16D;">Applications</span>:</h1>
      <div class="row">
        <div class="col-md-3">
            <div class="card">
